...
# #### Bipartite matrix
# For a given connectance, get the maximally bipartite matrix, assuming within block and between block ER graphs
...
# #### Modular matrix
# For a given connectance, get the maximally modular matrix, assuming within block and between block ER graphs
